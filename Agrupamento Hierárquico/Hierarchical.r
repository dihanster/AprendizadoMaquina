...
clusters <- hclust(dist(iris_norm[, 1:4]),method="single")
plot(clusters,hang=-1)
...
clusters <- hclust(dist(iris_norm[, 1:4]),method="average")
plot(clusters,hang=-1)
...
#res <- hclust(dist(data_norm),method="complete") # nstart tries different initializations and finds the one with lowest within variance
#res <- hclust(dist(data_norm),method="average") # nstart tries different initializations and finds the one with lowest within variance
