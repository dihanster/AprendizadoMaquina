...
#50  Species set 12 vers 9 virg 9
#100 Species set 14 vers 10 virg 6
#200 Species set 11 vers 8 vrig 11
...
#Com x0 = 0.75 o valor do bias^2 obtido foi menor e o ponto ficou mais a esquerda.
